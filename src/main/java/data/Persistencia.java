...
public class Persistencia {
    ...
    private static void inicializarVehiculos(){
        ...
        VehiculoElectrico v1 = new VehiculoElectrico("AE123FG", new Marca("Renault","Francia"), "Kangoo E-Tech", 2020, 1000, s1);
        VehiculoElectrico v2 = new VehiculoElectrico("AF456HI", new Marca("Ford","Estados Unidos"), "E-Transit", 2021, 1300, s2);
